...
class CabinetPropertyPanel(QWidget):
    ...
    def _build_action_row(self):
        ...
        b1.setStyleSheet(f"""QPushButton{{background:#f0f4fa;border:1px solid {_BORD};
            ...
            QPushButton:hover{{background:#dce7f8;border-color:{_BLUE};}}""")
        b1.clicked.connect(self.sig_add_or_modify); lay.addWidget(b1,1)
        b2 = QPushButton("↩"); b2.setToolTip("撤销"); b2.setFixedSize(26,25)
    ...
    def _build_save_row(self):
        ...
        b1.clicked.connect(self.sig_save_to_library); lay.addWidget(b1,1)
    ...
    def _build_finish(self):
        ...
        btn.clicked.connect(self.sig_finish_design)
